    ...
    <section id="paquetes" className="py-20 bg-white">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <h2 className="text-4xl md:text-5xl font-light text-gray-900 mb-4">Paquetes Turísticos</h2>
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">
            Experiencias cuidadosamente diseñadas para crear recuerdos inolvidables
          </p>
        </div>
          ...
          {packages.map((pkg, index) => (
            <Card key={index} className="border-0 shadow-lg hover:shadow-xl transition-shadow duration-300">
              <CardHeader className="text-center pb-4">
                <CardTitle className="text-2xl font-light text-gray-900 mb-2">{pkg.title}</CardTitle>
                <CardDescription className="text-gray-600 mb-4">{pkg.description}</CardDescription>
                <div className="text-center">
                  <span className="text-4xl font-light text-[#268367]">{pkg.price}</span>
              ...
              <CardContent>
                ...
                <Button className="w-full bg-[#268367] hover:bg-[#1e6b52] text-white">Reservar Paquete</Button>
              </CardContent>
            </Card>
          ))}
        </div>
